...
public class DeadLinePower extends BasePower {
    public static final String POWER_ID = makeID("DeadLinePower");
...
//    public static int cnts = 0;
    ...
    public DeadLinePower(AbstractCreature owner, int amount) {
...
//    }
    ...
    public void atEndOfTurn(boolean isPlayer) {
        addToBot(new LoseHPAction(AbstractDungeon.player, AbstractDungeon.player,10000));
    }
