...
import zmdzzzMod.cards.*;
import zmdzzzMod.relics.H2CO3Relic;
import zmdzzzMod.relics.StockRelic;
import zmdzzzMod.relics.ZmdRelic;

import java.util.ArrayList;

import static zmdzzzMod.BasicMod.characterPath;
import static zmdzzzMod.BasicMod.makeID;

public class zmd extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("zmd"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new zmd(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
...
//        retVal.add(Opo.ID);
        retVal.add(Roll.ID);
        retVal.add(Roll.ID);
//        retVal.add(ExamForm.ID);
//        retVal.add(HavingMD.ID);
//        retVal.add(AllKill.ID);
        retVal.add(DualDegree.ID);
        retVal.add(DualDegree.ID);
        retVal.add(Resonance.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(ZmdRelic.ID);
//        retVal.add(StockRelic.ID);
//        retVal.add(H2CO3Relic.ID);
