...
public class Resonance extends BaseCard {
    public static final String ID = makeID(Resonance.class.getSimpleName());
...
//        addToBot(new ApplyPowerAction(m, AbstractDungeon.player, new WeakPower(m,AbstractDungeon.player.hasPower(ShiliPower.POWER_ID)?AbstractDungeon.player.getPower(ShiliPower.POWER_ID).amount:0,false)));
        addToBot((AbstractGameAction)new GainBlockAction((AbstractCreature)p, (AbstractCreature)p, m.currentBlock*magicNumber+10));
    }
