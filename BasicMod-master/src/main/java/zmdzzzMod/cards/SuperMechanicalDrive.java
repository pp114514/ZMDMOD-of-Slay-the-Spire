...
public class SuperMechanicalDrive extends BaseCard {
    public static final String ID = makeID(SuperMechanicalDrive.class.getSimpleName());
...
//        tags.add(CardTags.STRIKE);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        int tmp2=AbstractDungeon.player.currentHealth;
        if(upgraded){
            tmp1*=5;
        }
        AbstractDungeon.player.currentBlock=tmp2;
        AbstractDungeon.player.currentHealth=tmp1;
    }
...
//    }
    ...
    public AbstractCard makeCopy() { //Optional
        return new SuperMechanicalDrive();
    }
}