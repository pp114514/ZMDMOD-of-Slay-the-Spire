...
import zmdzzzMod.BasicMod;
import zmdzzzMod.util.CardStats;
import zmdzzzMod.util.TriFunction;
...
import static zmdzzzMod.util.GeneralUtils.removePrefix;
import static zmdzzzMod.util.TextureLoader.getCardTextureString;
